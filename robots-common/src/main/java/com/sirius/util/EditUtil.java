...
import com.sirius.enums.UsableFlagEnum;
...
public class EditUtil {
     ...
     * 失效字段名
     */
    private static final String USABLE_FLAG = "usableFlag";
    ...
    public static <T> Map<String,List<T>> editSeparate(List<T> existList, List<T> records,
        ...
        if(CollectionUtils.isEmpty(existList)){
            for (T t : records) {
                ...
                BeanUtil.setProperty(t,usableCode, UsableFlagEnum.ENABLE.getCode());
            }
            map.put(ADD,records);
            return map;
        }
